...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_example_d_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_example_d_std_{_ts}"
...
@boost(BoosterParams(queue_name=f"nosql_demo_v2_{_ts}", broker_kind=BrokerEnum.MEMORY_QUEUE))

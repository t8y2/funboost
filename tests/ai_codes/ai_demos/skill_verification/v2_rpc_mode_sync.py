"""验证 funboost-rpc-mode SKILL.md — 同步 RPC 模式示例"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_rpc_sync_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_rpc_sync_std_{_ts}"

"""验证 funboost-spider-crawling SKILL — 函数级重试示例"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_spider_retry_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_spider_retry_std_{_ts}"

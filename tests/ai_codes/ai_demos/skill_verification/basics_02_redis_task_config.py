"""验证 using-funboost-basics: Redis 任务配置示例（broker 改用 MEMORY_QUEUE 避免外部依赖）"""
import os
import time

os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"basics_02_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"basics_02_std_{_ts}"

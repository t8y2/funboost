"""round3b r2: 批量运行 r2_faas_retry_mixin_* 验证脚本并汇总"""
import glob
import os
import subprocess
import sys
...
SCRIPTS_DIR = os.path.join(ROOT, "tests", "ai_codes", "ai_demos", "skill_verification", "round3b")
TIMEOUT = 90

scripts = sorted(glob.glob(os.path.join(SCRIPTS_DIR, "r2_faas_retry_mixin_*.py")))

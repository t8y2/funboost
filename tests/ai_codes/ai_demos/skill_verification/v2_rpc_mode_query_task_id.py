"""验证 funboost-rpc-mode SKILL.md — 根据 task_id 查询结果示例"""
import asyncio
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_rpc_query_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_rpc_query_std_{_ts}"

"""验证 funboost-observability SKILL §2 OTel 链式任务示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_06_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_06_std_{_ts}"
...
@boost(OtelBoosterParams(
    queue_name=f"v2_obs_otel_entry_{_ts}",
...
@boost(OtelBoosterParams(
    queue_name=f"v2_obs_otel_process_{_ts}",
    broker_kind=BrokerEnum.MEMORY_QUEUE,
    concurrent_num=2,
))

"""验证 funboost-spider-crawling SKILL — SpiderResponse 解析方法"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_spider_response_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_spider_response_std_{_ts}"

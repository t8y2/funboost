"""验证 funboost-observability SKILL §2 init_opentelemetry 前置初始化"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_05_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_05_std_{_ts}"

"""验证 skill: funboost-advanced-retry — advanced_retry_config 自定义退避示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_retry_custom_cfg_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_retry_custom_cfg_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="v2_custom_backoff_task",
...
if __name__ == "__main__":
    try:
        params = custom_backoff_task.consumer_params

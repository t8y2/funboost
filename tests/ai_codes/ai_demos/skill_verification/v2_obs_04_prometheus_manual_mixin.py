"""验证 funboost-observability SKILL §1 手动指定 Prometheus Mixin"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_04_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_04_std_{_ts}"
...
start_prometheus_http_server(port=18004)

@boost(BoosterParams(
    queue_name=f"v2_obs_prom_manual_{_ts}",

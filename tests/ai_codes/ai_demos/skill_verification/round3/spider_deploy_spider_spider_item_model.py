"""round3 验证 funboost-spider-crawling SKILL — SpiderItem 数据模型与 upsert"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_item_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_item_std_{_ts}"
...
SQLITE_ENGINE = create_engine(f"sqlite:///r3_spider_item_{_ts}.db")

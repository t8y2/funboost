...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_09_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_09_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"monitor_mixin_r3_{_ts}",
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_09_monitor_hooks")

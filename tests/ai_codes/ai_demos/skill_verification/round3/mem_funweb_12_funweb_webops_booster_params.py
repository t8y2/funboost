...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"mem_funweb_12_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"mem_funweb_12_std_{_ts}"
...
if __name__ == "__main__":
    bp = WebOpsBoosterParams(queue_name=f"webops_r3_{_ts}")

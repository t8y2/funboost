...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_05_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_05_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_05_kw_dict_structure")
    kw_task.push(99)
    kw_task.consume()
    time.sleep(15)
    ok = (

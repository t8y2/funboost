"""round3 验证: funboost-advanced-retry — 基础重试示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"faas_retry_06_basic_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"faas_retry_06_basic_std_{_ts}"

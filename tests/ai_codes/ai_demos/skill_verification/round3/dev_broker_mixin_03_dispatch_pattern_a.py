...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_03_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_03_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_03_dispatch_pattern_a")
    task_a.push(1)
    task_a.consume()
    time.sleep(15)
    if DONE == [1]:

...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_06_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_06_std_{_ts}"
...
_BROKER = f"MY_BROKER_CFG_R3_{_ts}"
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_06_exclusive_config")
    cfg_task.push(1)
    cfg_task.consume()
    time.sleep(15)

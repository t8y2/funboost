...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_02_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_02_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"custom_task_r3_{_ts}",
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_02_override_cls_mixin")
    my_task.push(42)
    my_task.consume()
    time.sleep(15)

"""验证 SKILL: funboost-async-programming §6 FastAPI（MEMORY_QUEUE 适配）"""
import asyncio
import os
import time
...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"test_async_6_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"test_async_6_std_{_ts}"
...
@boost(
    BoosterParams(
        queue_name=f"web_async_task_{_ts}",

...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"timing_wf_timing_full_heartbeat_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"timing_wf_timing_full_heartbeat_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] timing_wf_timing_full_heartbeat")
    heartbeat.consume()
    ...
    time.sleep(20)
    print("[DONE] timing_wf_timing_full_heartbeat")
    os._exit(66)

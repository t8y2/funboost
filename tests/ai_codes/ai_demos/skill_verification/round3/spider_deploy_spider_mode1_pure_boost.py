"""round3 验证 funboost-spider-crawling SKILL — 模式1：纯 @boost 函数调度"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_mode1_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_mode1_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="r3_crawl_detail_mode1",
...
if __name__ == "__main__":
    try:
        ...
        report("BoosterParams.queue_name", params.queue_name == "r3_crawl_detail_mode1")

...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_13_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_13_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"pub_mixin_r3_{_ts}",
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_13_publisher_mixin")
    pub_task.push(3)
    pub_task.consume()
    time.sleep(15)

"""round3 验证: funboost-advanced-retry — 死信队列 DLX 示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"faas_retry_09_dlx_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"faas_retry_09_dlx_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="r3_important_task_dlx",
    broker_kind=BrokerEnum.MEMORY_QUEUE,
    concurrent_num=1,
))
...
if __name__ == "__main__":
    try:
        ...
        report(True, "is_push_to_dlx_queue_when_retry_max_times=True 配置无报错")

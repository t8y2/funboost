"""round3 验证 using-funboost-basics 示例5: 异步 aio_push / aio_publish"""
import asyncio
import os
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_basics_05_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_basics_05_std_{_ts}"

from funboost import boost, BoosterParams, BrokerEnum, TaskOptions


@boost(BoosterParams(queue_name="r3_basics_05_async", broker_kind=BrokerEnum.MEMORY_QUEUE))

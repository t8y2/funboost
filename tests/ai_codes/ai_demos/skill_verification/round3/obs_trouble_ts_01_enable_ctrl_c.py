"""验证 round3 / funboost-troubleshooting SKILL §1.2 enable_ctrl_c_quit_on_windows 交互式脚本"""
import os
import time
import inspect
...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_ts_01_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_ts_01_std_{_ts}"

from funboost import boost, BoosterParams, BrokerEnum, enable_ctrl_c_quit_on_windows

@boost(BoosterParams(
    queue_name=f"obs_trouble_ts_ctrl_c_{_ts}",

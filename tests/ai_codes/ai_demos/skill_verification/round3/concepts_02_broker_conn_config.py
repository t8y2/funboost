"""round3 验证 understanding-funboost-concepts 示例2: BrokerConnConfig 配置类示例"""
import os
import time

os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_concepts_02_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_concepts_02_std_{_ts}"

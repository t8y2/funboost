"""验证 round3 / funboost-troubleshooting SKILL §6.5 BrokerConnConfig SQLLITE_QUEUES_PATH 配置片段"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_ts_15_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_ts_15_std_{_ts}"

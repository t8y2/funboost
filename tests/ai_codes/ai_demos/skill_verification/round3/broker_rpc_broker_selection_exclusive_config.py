"""验证 funboost-broker-selection SKILL.md — 示例3：broker_exclusive_config"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"broker_rpc_broker_exclusive_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"broker_rpc_broker_exclusive_std_{_ts}"

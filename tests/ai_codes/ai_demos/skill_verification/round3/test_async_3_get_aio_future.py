...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"test_async_3_future_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"test_async_3_future_std_{_ts}"
...
@boost(
    BoosterParams(
        queue_name=f"get_aio_future_demo_{_ts}",

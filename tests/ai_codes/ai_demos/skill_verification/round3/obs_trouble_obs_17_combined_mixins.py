"""验证 round3 / funboost-observability SKILL §6 组合多种 Mixin"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_obs_17_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_obs_17_std_{_ts}"
...
start_prometheus_http_server(port=18317)

@boost(BoosterParams(
    queue_name=f"obs_trouble_obs_combined_{_ts}",

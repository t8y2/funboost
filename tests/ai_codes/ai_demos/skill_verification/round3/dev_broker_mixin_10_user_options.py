...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_10_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_10_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"user_options_r3_{_ts}",
...
if __name__ == "__main__":
    print("[START] dev_broker_mixin_10_user_options")
    opts_task.push(1)
    opts_task.consume()
    time.sleep(15)

"""round3 验证 funboost-spider-crawling SKILL — SimpleSpiderClient 同步客户端"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_simple_client_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_simple_client_std_{_ts}"

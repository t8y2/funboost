"""round3 验证 funboost-remote-deploy SKILL — kill_all_remote_tasks"""
import inspect
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_remote_kill_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_remote_kill_std_{_ts}"

"""验证 round3 / funboost-troubleshooting SKILL §4.1 event loop already running 解决方案"""
import os
import time
import asyncio
...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_ts_09_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_ts_09_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"obs_trouble_ts_eloop_{_ts}",

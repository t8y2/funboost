"""验证 funboost-broker-selection SKILL.md — 示例2：Broker 连接配置"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"broker_rpc_broker_conn_config_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"broker_rpc_broker_conn_config_std_{_ts}"

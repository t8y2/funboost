...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"dev_broker_mixin_07_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"dev_broker_mixin_07_std_{_ts}"
...
if __name__ == "__main__":
    ...
    @boost(BoosterParams(
        queue_name=f"mixin_tpl_r3_{_ts}",
    ...
    print("[START] dev_broker_mixin_07_mixin_template")
    tpl_task.push(5)
    tpl_task.consume()
    time.sleep(15)

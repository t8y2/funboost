"""round3 验证 funboost-spider-crawling SKILL — 精准 QPS + 分布式控频"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_qps_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_qps_std_{_ts}"

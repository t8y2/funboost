"""round3 验证 funboost-spider-crawling SKILL — do_task_filtering 去重配置"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_filter_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_filter_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="r3_news_detail_filter",

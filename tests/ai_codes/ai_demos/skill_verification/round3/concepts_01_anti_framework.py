"""round3 验证 understanding-funboost-concepts 示例1: 反框架设计 process 示例"""
import os
import time

os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_concepts_01_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_concepts_01_std_{_ts}"

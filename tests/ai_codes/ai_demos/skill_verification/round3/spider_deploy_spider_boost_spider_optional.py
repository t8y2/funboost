"""round3 验证 funboost-spider-crawling SKILL — boost_spider 可选包 import"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"r3_spider_boost_spider_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"r3_spider_boost_spider_std_{_ts}"

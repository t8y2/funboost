"""round3 验证: funboost-advanced-retry — 组合多种策略 resilient_task 示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"faas_retry_14_combined_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"faas_retry_14_combined_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="r3_resilient_pipeline",

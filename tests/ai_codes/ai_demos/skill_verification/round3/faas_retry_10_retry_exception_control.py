"""round3 验证: funboost-advanced-retry — ExceptionForRequeue / ExceptionForPushToDlxqueue 示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"faas_retry_10_exception_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"faas_retry_10_exception_std_{_ts}"
...
@boost(BoosterParams(
    queue_name="r3_controlled_retry",

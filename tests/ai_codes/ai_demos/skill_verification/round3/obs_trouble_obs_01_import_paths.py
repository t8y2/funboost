"""验证 round3 / funboost-observability SKILL §导入路径速查"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_obs_01_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_obs_01_std_{_ts}"

"""验证 round3 / funboost-troubleshooting SKILL §3 步骤2 queue_name 必须一致"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"obs_trouble_ts_06_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"obs_trouble_ts_06_std_{_ts}"

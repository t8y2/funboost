...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_broker_04_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_broker_04_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] v2_broker_04_dispatch_pattern_b")
    task_b.push(2)
    task_b.push(3)
    task_b.consume()
    time.sleep(15)

"""验证 funboost-troubleshooting SKILL §7.2 方式A subprocess + timeout 模式"""
import os
import subprocess
import sys
import time
...
TARGET = os.path.join(os.path.dirname(__file__), "v2_ts_03_ai_test_exit.py")
...
if __name__ == "__main__":
    ...
    # v2_ts_03 使用 os._exit(66)，Windows 上 returncode 可能为 66

"""验证 skill: funboost-advanced-retry — 指数退避重试示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_retry_backoff_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_retry_backoff_std_{_ts}"

...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_testing_mixin_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_testing_mixin_std_{_ts}"
...
@boost(
    BoosterParams(
        queue_name=f"test_counter_mixin_v2_{_ts}",

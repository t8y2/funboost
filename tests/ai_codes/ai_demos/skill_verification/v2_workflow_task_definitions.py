...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_workflow_task_definitions_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_workflow_task_definitions_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] v2_workflow_task_definitions")
    ...
    time.sleep(20)
    print("[DONE] v2_workflow_task_definitions")
    os._exit(66)

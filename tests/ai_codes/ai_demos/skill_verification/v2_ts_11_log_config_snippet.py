"""验证 funboost-troubleshooting SKILL §5.3 FunboostCommonConfig 减少启动刷屏配置片段"""
import os
import time
import logging
...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_ts_11_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_ts_11_std_{_ts}"

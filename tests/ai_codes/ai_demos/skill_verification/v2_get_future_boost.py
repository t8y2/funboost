...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_get_future_boost_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_get_future_boost_std_{_ts}"

from funboost import boost, BoosterParams, BrokerEnum


@boost(BoosterParams(queue_name=f"demo_v2_{_ts}", broker_kind=BrokerEnum.MEMORY_QUEUE, concurrent_num=10))
def add(x, y):
    return x + y

...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_workflow_nested_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_workflow_nested_std_{_ts}"
...
if __name__ == "__main__":
    print("[START] v2_workflow_nested")
    download.consume()
    process.consume()
    notify.consume()
    time.sleep(2)

"""验证 skill: funboost-advanced-retry — 获取重试上下文 fct 示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_retry_context_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_retry_context_std_{_ts}"
...
if __name__ == "__main__":
    try:
        ...
        report(True, "task_with_context 第2次执行成功")

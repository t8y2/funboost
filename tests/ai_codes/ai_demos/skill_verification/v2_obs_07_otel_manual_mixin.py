"""验证 funboost-observability SKILL §2 手动指定 OTel Mixin"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_07_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_07_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"v2_obs_otel_manual_{_ts}",

...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_workflow_group_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_workflow_group_std_{_ts}"
...
@boost(WfParams(queue_name="v2_wf_group_process"))

"""验证 funboost-remote-deploy SKILL — 导入方式（fabric_deploy 不在顶层导出）"""
import inspect
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_remote_import_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_remote_import_std_{_ts}"

"""验证 funboost-observability SKILL §3 AlertNotifier 自定义告警渠道"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_10_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_10_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"v2_obs_alert_custom_{_ts}",

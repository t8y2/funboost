...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_mixin_05_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_mixin_05_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"combined_task_v2_{_ts}",
...
if __name__ == "__main__":
    print("[START] v2_mixin_05_combined")
    try:
        my_task.push(7)
        my_task.consume()
        time.sleep(15)

"""验证 funboost-troubleshooting SKILL §2 PYTHONPATH 与 funboost_config 加载"""
import os
import sys
import time
...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_ts_04_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_ts_04_std_{_ts}"

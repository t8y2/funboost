"""验证 funboost-observability SKILL §7 完整综合示例"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_18_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_18_std_{_ts}"
...
init_opentelemetry()
start_prometheus_http_server(port=18018)

@boost(BoosterParams(
    queue_name=f"v2_obs_full_{_ts}",

...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_broker_01_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_broker_01_std_{_ts}"

from funboost import register_custom_broker, boost, BoosterParams
from funboost.publishers.base_publisher import AbstractPublisher
from funboost.consumers.base_consumer import AbstractConsumer

# --- 模拟 SKILL 中的 connect_to_my_mq() ---
_MQ_STORE = {}
_MQ_LOCK = Lock()
...
_BROKER_KIND = f"MY_BROKER_V2_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"test_v2_broker_01_{_ts}",
...
if __name__ == "__main__":
    print("[START] v2_broker_01_register_custom_broker")
    ar = my_task.push(7)

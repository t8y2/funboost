"""验证 funboost-spider-crawling SKILL — AsyncSpiderClient + ASYNC 模式"""
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_spider_async_client_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_spider_async_client_std_{_ts}"

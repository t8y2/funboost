"""验证 funboost-rpc-mode SKILL.md — 异步 RPC 模式示例"""
import asyncio
import os
import sys
import time
...
_ts = int(time.time())
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_rpc_async_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_rpc_async_std_{_ts}"

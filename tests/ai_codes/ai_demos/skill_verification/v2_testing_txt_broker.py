...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_testing_txt_broker_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_testing_txt_broker_std_{_ts}"
...
@boost(
    BoosterParams(
        queue_name=f"test_txt_broker_v2_{_ts}",

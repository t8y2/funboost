"""验证 funboost-observability SKILL §5 BrokerConnConfig MONGO_CONNECT_URL 配置片段"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_13_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_13_std_{_ts}"

"""验证 funboost-observability SKILL §1 Prometheus Push Gateway 模式"""
import os
import time

_ts = int(time.time())
os.environ["LOG_PATH"] = r"D:\pythonlogs\ai_console_outs"
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_obs_03_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_obs_03_std_{_ts}"
...
@boost(PrometheusPushGatewayBoosterParams(
    queue_name=f"v2_obs_prom_push_{_ts}",

...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_funweb_multi_consumer_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_funweb_multi_consumer_std_{_ts}"
...
@boost(WebOpsBoosterParams(queue_name=f"worker_queue_v2_{_ts}", qps=2, concurrent_num=10))
def process_task(x):
    return x * 2

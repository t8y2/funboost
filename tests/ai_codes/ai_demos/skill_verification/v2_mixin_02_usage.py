...
os.environ["PRINT_WRTIE_FILE_NAME"] = f"v2_mixin_02_{_ts}"
os.environ["SYS_STD_FILE_NAME"] = f"v2_mixin_02_std_{_ts}"
...
@boost(BoosterParams(
    queue_name=f"monitored_task_v2_{_ts}",
